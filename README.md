...
| **ECharts 报告** | 柱状图 / 雷达图 / 饼图，三厂商防护率对比，自动输出推荐采购结论 |
...
│   ├── sqli.json     (168 条)    nosql / ssti / upload / bypass_transforms
│   ├── xss.json      (111 条)
│   ├── cmd.json       (66 条)
│   ├── ssrf.json      (48 条)
│   ├── lfi.json       (36 条)
...
| `logger_csv.py` | CSV 导出 |
| `report_generator.py` | HTML + ECharts 报告生成 |
